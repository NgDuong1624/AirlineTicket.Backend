...
namespace AirlineTicket.Modules.Flights.Infrastructure.Migrations
{
    ...
    [Migration("20260910025326_AddFlightTelemetryAndLiveRadarFields")]
    partial class AddFlightTelemetryAndLiveRadarFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirlineTicket.Modules.Flights.Domain.Entities.Flight", b =>
                {
                    ...
                    b.Property<string>("BaggageCarousel")
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                        .HasColumnName("baggage_carousel");
            ...
            modelBuilder.Entity("AirlineTicket.Modules.Flights.Domain.Entities.FlightPriceHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_flight_price_histories");

                    b.HasIndex("FlightId", "RecordedAt")
                    ...
                    b.ToTable("flight_price_histories", "flights");
                });
            ...
            modelBuilder.Entity("AirlineTicket.Modules.Flights.Domain.Entities.FlightTelemetry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<short>("ProgressPercentage")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_flight_telemetry");

                    b.HasIndex("FlightId", "RecordedAt")
                        .HasDatabaseName("ix_flight_telemetry_flight_id_recorded_at");

                    b.ToTable("flight_telemetry", "flights");
                });
            ...
            modelBuilder.Entity("AirlineTicket.Modules.Flights.Domain.Entities.FlightPriceHistory", b =>
                {
                    b.HasOne("AirlineTicket.Modules.Flights.Domain.Entities.Flight", "Flight")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_flight_price_histories_flights_flight_id");
                    ...
                    b.HasOne("AirlineTicket.Modules.Flights.Domain.Entities.Route", "Route")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_flight_price_histories_routes_route_id");
            ...
            modelBuilder.Entity("AirlineTicket.Modules.Flights.Domain.Entities.FlightTelemetry", b =>
                {
                    b.HasOne("AirlineTicket.Modules.Flights.Domain.Entities.Flight", "Flight")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_flight_telemetry_flights_flight_id");
