...
public interface IPromotionRepository
{
    ...
    Task<bool> UpdateAsync(PromotionDto promotion, CancellationToken cancellationToken = default);
    ...
    Task<bool> UpdateCouponAsync(Coupon coupon, Guid airlineId, CancellationToken cancellationToken = default);
    Task<bool> DeleteCouponAsync(Guid id, Guid airlineId, CancellationToken cancellationToken = default);
