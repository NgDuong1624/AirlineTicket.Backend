...
public class PromotionEndpointsTests // : IClassFixture<WebApplicationFactory<Program>>
{
    // private readonly HttpClient _client;

    // public PromotionEndpointsTests(WebApplicationFactory<Program> factory)
    // {
    ...
    public async Task GetActivePromotions_ShouldReturnOk()
    {
        ...
        // var response = await _client.GetAsync("/api/v1/promotions/active");
